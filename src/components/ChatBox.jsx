...
export default function ChatBox({ teacherId, studentId, role }) {
  ...
  return (
    <div className="flex flex-col h-full bg-solid-secondary rounded-[2rem] border border-primary overflow-hidden shadow-2xl">
      {/* Header */}
      <div className="p-4 border-b border-primary bg-solid-primary flex items-center gap-3">
      ...
      {/* Input */}
      <form onSubmit={handleSend} className="p-4 bg-solid-primary border-t border-primary flex gap-2">
        <input 
